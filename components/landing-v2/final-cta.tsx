		...
		<section className="relative px-5 py-20 sm:px-6 lg:py-28">
			...
			<Reveal className="mx-auto max-w-4xl">
				<div className="relative overflow-hidden rounded-[2.5rem] border border-amber-500/30 px-6 py-16 text-center sm:px-12 sm:py-20">
					{/* Фоновые слои */}
					<div
						className="pointer-events-none absolute inset-0 bg-gradient-to-br from-amber-500/10 via-stone-900/50 to-stone-950"
						aria-hidden
					/>
					<div
					...
					{/* Орбы */}
					<div
						className="pointer-events-none absolute -left-20 top-1/2 size-64 -translate-y-1/2 rounded-full bg-amber-500/10 blur-3xl"
						aria-hidden
					/>
					<div
						className="pointer-events-none absolute -right-20 top-1/2 size-64 -translate-y-1/2 rounded-full bg-amber-500/8 blur-3xl"
						aria-hidden
					/>
					<div
						className="pointer-events-none absolute bottom-0 left-1/2 size-80 -translate-x-1/2 translate-y-1/2 rounded-full bg-amber-500/6 blur-3xl"
						aria-hidden
					/>

					{/* Декоративные кольца */}
					<div
						className="pointer-events-none absolute left-1/2 top-1/2 size-[480px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-amber-500/[0.08]"
						aria-hidden
					/>
					<div
						className="pointer-events-none absolute left-1/2 top-1/2 size-[320px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-amber-500/[0.06]"
						aria-hidden
					/>
					...
					<div className="relative">
						<span className="inline-flex items-center gap-2 rounded-full border border-amber-500/30 bg-amber-500/10 px-4 py-1.5 text-xs font-semibold text-amber-200">
							<Gift className="size-3.5" />+{PRICES.welcomeBonus}{" "}
							₽ при регистрации
						</span>
						...
						<p className="mx-auto mt-4 max-w-lg text-pretty text-base leading-relaxed text-stone-400">
							Зарегистрируйтесь, получите {PRICES.welcomeBonus} ₽
							на баланс и запустите первый AI-анализ без вложений.
						</p>
