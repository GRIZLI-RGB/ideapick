...
const BANDS: Band[] = [
	{
		...
		sample:   22,
		title:    "Слабая идея",
		text:     "Низкий потенциал или критичные риски. Скорее всего, не стоит вложений.",
	...
	},
	{
		...
		sample:   42,
		title:    "Сомнительно",
		text:     "Серьёзные слабые места — браться стоит только после доработки концепции.",
	...
	},
	{
		...
		text:     "Потенциал есть, но с оговорками. Сначала дёшево проверьте ключевые гипотезы.",
	...
	},
	{
		...
		sample:   84,
		title:    "Сильная идея",
		text:     "Перспективна даже с ограничениями соло-разработчика. Можно браться.",
		...
		<section className="relative scroll-mt-20 px-5 py-16 sm:px-6">
			...
			<div className="mx-auto max-w-6xl">
				<SectionHeading
					...
					description="Все факторы сводятся в общий рейтинг 0–100 с цветовой подсказкой — расклад понятен за секунду."
				/>
