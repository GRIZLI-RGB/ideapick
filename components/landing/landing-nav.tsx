...
export function LandingNav() {
	...
	return (
		<header className="fixed inset-x-0 top-0 z-50">
			...
			>
				<nav className="mx-auto flex h-14 max-w-6xl items-center justify-between px-5 sm:px-6">
					...
					<div className="flex items-center gap-2">
						...
						<Link
							href="/login"
							className="group hidden items-center gap-1.5 rounded-xl bg-amber-500 px-4 py-2 text-sm font-semibold text-stone-950 transition hover:bg-amber-400 sm:inline-flex"
						>
							Начать
			...
			{/* Мобильное меню — CSS transition вместо framer */}
			<div
