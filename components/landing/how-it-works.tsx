...
const STEPS: Step[] = [
	{
		...
		step: "01",
		title: "Добавьте идею",
		text: "Своя, случайная из каталога или сгенерированная AI по короткому опросу. Только название и пара предложений описания.",
	...
	},
	{
		...
		text: "AI разбирает рынок, конкурентов, монетизацию и сложность реализации для одного человека. Занимает около минуты.",
	...
	},
	{
		...
		text: "Одна понятная оценка 0–100 и структурированный отчёт из шести разделов — без воды и простыней текста.",
	...
	},
	{
		icon: Rocket,
		step: "04",
		title: "Решайте на фактах",
		text: "Брать в работу, доработать формулировку или отложить. Меньше догадок — меньше потраченного впустую времени.",
...
export function HowItWorks() {
	return (
		<section id="how" className="relative scroll-mt-20 px-5 py-20 sm:px-6 lg:py-28">
			{/* Лёгкий gradient-divider сверху */}
			...
			<div className="mx-auto max-w-6xl">
				<SectionHeading
					...
					title="Четыре шага от сырой идеи до решения"
					description="IdeaPick устроен так, чтобы вы вводили минимум, а получали максимум обоснованных выводов."
				/>
					...
					{STEPS.map((step, i) => {
						...
						return (
							...
							>
								...
								{/* Коннектор → только на десктопе, для последнего — скрыт */}
								{i < STEPS.length - 1 && (
									<div
