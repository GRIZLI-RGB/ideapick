...
const FAQ: { q: string; a: string }[] = [
	...
	{
		q: "Сколько это стоит?",
		a: "Подписки нет. AI-анализ — 99 ₽, генерация идей по анамнезу — 49 ₽, идея из каталога — бесплатно. При регистрации дарим 100 ₽ на баланс, которых хватает на первый анализ.",
	},
	{
	...
	{
		q: "Как войти?",
		a: "Без паролей: через аккаунт Google или magic-link на почту. Первый вход автоматически создаёт аккаунт и начисляет приветственные 100 ₽.",
	},
];
...
function FaqItem({ q, a, index }: { q: string; a: string; index: number }) {
	...
	return (
		...
		>
			...
			>
				<p className="px-5 pb-5 text-sm leading-relaxed text-stone-400">{a}</p>
			</div>
		</Reveal>
	);
}
