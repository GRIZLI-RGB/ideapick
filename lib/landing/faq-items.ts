...
export const LANDING_FAQ_ITEMS: LandingFaqItem[] = [
	...
	{
		q: "Сколько это стоит?",
		a: `Подписки нет. AI-анализ — ${PRICES.analysis} ₽, подборка идей под ваш профиль — ${PRICES.anamnesis} ₽, идея из каталога — бесплатно. При регистрации дарим ${PRICES.welcomeBonus} ₽ на баланс — их хватает на первый анализ.`,
	},
	{
	...
	{
		q: "Как войти?",
		a: `Без паролей: через аккаунт Google или по ссылке из письма. Первый вход автоматически создаёт аккаунт и начисляет приветственные ${PRICES.welcomeBonus} ₽.`,
	},
];
